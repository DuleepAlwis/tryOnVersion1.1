...
@Component({
  selector: 'app-bottum-measurement',
  templateUrl: './bottum-measurement.component.html',
  styleUrls: ['./bottum-measurement.component.css']
})
export class BottumMeasurementComponent implements OnInit {
